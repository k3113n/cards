        ...
        const svg = await satori(
          ...
          />, {
            ...
            fonts: [
              ...
              {
                name: "NotoSansSC",
                data: await Deno.readFile("/usr/share/fonts/noto/NotoSansCJKSC.otf"),
                weight: 400,
                style: "normal",
              },
              {
                name: "NotoSansTC",
                data: await Deno.readFile("/usr/share/fonts/noto/NotoSansCJKTC.otf"),
                weight: 400,
                style: "normal",
              },
              {
                name: "NotoSansJP",
                data: await Deno.readFile("/usr/share/fonts/noto/NotoSansCJKJP.otf"),
                weight: 400,
                style: "normal",
              },
              {
                name: "NotoSansKR",
                data: await Deno.readFile("/usr/share/fonts/noto/NotoSansCJKKR.otf"),
                weight: 400,
                style: "normal",
              },
              {
